...
<head>
    ...
    <meta name="description" content="Laravel_shop project">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="header_content d-flex flex-row align-items-center justify-content-start">
                                <div class="logo"><a href="/">Laravel shop</a></div>
                                <nav class="main_nav">
                                    <ul>
                ...
                <div class="row">
                    <div class="col">
                        <div class="footer_content d-flex flex-lg-row flex-column align-items-center justify-content-lg-start justify-content-center">
                            <div class="footer_logo"><a href="#">Laravel shop</a></div>
                            <div class="copyright ml-auto mr-auto">
                                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                                ! &copy;<script>
                                    document.write(new Date().getFullYear());
                                </script> Something <i class="fa fa-heart-o" aria-hidden="true"></i> cool <a href="#" target="_blank">Text</a>
                                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                            </div>
